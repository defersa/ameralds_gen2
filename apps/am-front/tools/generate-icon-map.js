...
const PATH_TO_INPUT = './apps/am-front/src/app/cdk/icons/icons.list.json';
const PATH_TO_OUTPUT = './apps/am-front/src/app/cdk/icons/icons.map.ts';
const PATH_TO_ICONS = './apps/am-front/src/public/assets/icons/';
